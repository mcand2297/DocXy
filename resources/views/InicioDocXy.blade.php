			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<section class="box special">
						...
						<ul class="actions">
							<li><a href="{{ route('docente.showLoginForm') }}" class="button alt">Ingresar como docente</a></li>
						</ul>
						<ul class="actions">
							<li><a href="{{ route('acudiente.showLoginForm') }}" class="button alt">Ingresar como acudiente</a></li>
						</ul>
						<br><br><br>
            <div id="social">
